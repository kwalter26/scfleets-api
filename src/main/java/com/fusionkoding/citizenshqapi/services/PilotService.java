...
public interface PilotService {
  public List<PilotDTO> getPilots();
    ...
    public PilotDTO updatePilot(String pilotId, String userName, String email, String rsiHandle,
            String rsiProfileImgUrl, String lang, String timeZone, Boolean verfied, 
            String verificationCode, String ueeRecordNumber, String fluency, String enlistDate, String country) throws NotFoundException;
